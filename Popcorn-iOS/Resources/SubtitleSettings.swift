...
class SubtitleSettings: NSObject, NSCoding {
    ...
    enum Quality: Double {
        ...
        static let array = [low, medium, high, perfect]
    ...
    required init?(coder aDecoder: NSCoder) {
        guard let color = aDecoder.decodeObject(of: UIColor.self, forKey: "color"),
            ...
            let rawQuality = aDecoder.decodeObject(forKey: "quality") as? Double,
            let size = Size(rawValue: Float(rawSize)),
            let quality = Quality(rawValue: Double(rawQuality)),
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(Double(quality.rawValue), forKey: "quality")
