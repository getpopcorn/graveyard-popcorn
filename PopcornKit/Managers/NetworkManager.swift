...
open class NetworkManager: NSObject {
    ...
    public enum MovieGenres: String {
        ...
        public static var array = [all, action, adventure, animation, anime, comedy, crime, disaster, documentary, drama, family, fanFilm, fantasy, filmNoir, history, holiday, horror, indie, music, mystery, romance, sciFi, short, sports, sportingEvent, suspense, thriller, war, western]
    ...
    public enum ShowGenres: String {
        ...
        public static var array = [all, action, adventure, animation, comedy, crime, disaster, documentary, drama, family, fanFilm, fantasy, filmNoir, history, holiday, horror, indie, music, mystery, romance, sciFi, short, sports, sportingEvent, suspense, thriller, war, western]
